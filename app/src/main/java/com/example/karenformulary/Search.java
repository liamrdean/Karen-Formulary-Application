...
public class Search {
    ...
    // keeping them in an array is useful for levenshtein's through it is more storage
    ...
    public void buildFromFile(){
        try{
            ...
            dictionary = new String[100]; // number would need to be changed for this, but we do know it
            int counter = 0;
            TrieNode current;
    ...
    public String[] closest( String guess){
        ...
        // keep a priorty queue for the results
